# /home/skefi/Dropbox/SantaFeWorkshopOctober2011/paper_space/CodeSpatialAna_Matlab
# R

#----------------------------------------------------------------------------------------------
# Analysis of rough data sets = vector of sizes
#----------------------------------------------------------------------------------------------
#----------------------------------------------------------------------------------------------

setwd("/home/skefi/Dropbox/SantaFeWorkshopOctober2011/paper_space/CodeSpatialAna_Matlab")

## removes all objects
rm(list=ls())

size.patches <- read.csv("DataPatchSize_TPBb39_rough.csv",sep="\t")
#DataPatchSize_DG_fuentiduena_ysa_GrayThresh
#DataPatchSize_TPBb39_rough

#----------------------------------------------------------------------------------------------
#----------------------------------------------------------------------------------------------
# Calculate and plot the cumu distri
#----------------------------------------------------------------------------------------------
xmin <- 1
