...
#' 
#' @details The data-set consists of a rectangular area of size 7.5 km x 90 km. This data 
#' is represented as a list of matrices. Each matrix is a moving window of 7.5 km x 7.5 km 
#' which moves my 2.5 km along the length of the rectangular data-set. 
#' Each entry in the matrix is vegetation data at a resolution of 30m as classified 
#' into binary units with 0(grass) and 1(wood).
