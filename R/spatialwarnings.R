...
#'  \itemize{ 
#'    \item \code{\link{indicator_moran}}: lag-1 spatial autocorrelation 
...
#' \link[=https://github.com/spatial-ews/spatialwarnings]{Github}
#' and a \link[=https://alex.lecairn.org/spatialwarnings-faq.html]{FAQ 
