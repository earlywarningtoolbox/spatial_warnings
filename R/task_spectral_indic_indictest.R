...
#' 
#' @export
indictest.spectral_spews <- function(obj, nperm = 999, ...) { 
...
#' @export
indictest.spectral_spews_list <- function(obj, nperm = 999, ...) { 
...
#' @export
indictest.spectral_spews_single <- function(obj, nperm = 999, ...) { 
