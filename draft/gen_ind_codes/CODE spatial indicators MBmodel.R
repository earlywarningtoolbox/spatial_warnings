...
load("result_musselbed_processed.rda")
...
######
#1. Compute Spectrum:
low_range<-c(1,0.2*floor((nrow(l[[1]])/2)))   ## initial points in powerspectrum are low frequency
...
remove(Res_dat,Transits_dat,landscapes,Varlist,Skewlist,Moranlist,subsize,DBplot1,DBplot2,MATRIX,MoranDF,VarDF,PspecDF,SkewDF,Pspeclist,dSEL,l)
